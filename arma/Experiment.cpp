...
{   
 ...
 //data.Change_to_Matrix(); 
  ...
  double b_APE=par.b_start,b_APAII=par.b_start,b_ASOP=par.b_start,b_AROW=par.b_start2;
  ...
  //else if (!this->data_name.compare("clean.b")){
	 ...
	 // par.AROW_eta = 32; par.find_AROW_eta = 0;
  ...
  //{
	 ...
	 // par.AROWC_r = 0.03125; par.find_AROWC_r = 0;	  
  //}
  ///*else if (!this->data_name.compare("covtype.b"))
  //{
	 // par.PAI_C = 0.25; par.find_PAI_C = 0;
	 // par.PAII_C = 0.03125; par.find_PAII_C = 0;
	 // par.AROW_r = 8; par.find_AROW_r = 0;
	 // par.AROW_eta = 32; par.find_AROW_eta = 0;
	 // par.AROWC_r = 0.03125; par.find_AROWC_r = 0;	  
	 // b_APE=-2.8;
	 // b_APAII=-4.1;
  ...
  //}*/
  //else if (!this->data_name.compare("ijcnn1.b"))
  //{
	 // par.PAI_C = 0.25; par.find_PAI_C = 0;
	 // par.PAII_C = 0.0625; par.find_PAII_C = 0;
	 // par.AROW_r = 16; par.find_AROW_r = 0;
	 // par.AROW_eta = 4; par.find_AROW_eta = 0;
	 // par.AROWC_r = 0.03125; par.find_AROWC_r = 0;	  
	 // 
  //}
  //else if (!this->data_name.compare("kddcup99_10Percent.b"))
  //{
	 // par.PAI_C = 0.25; par.find_PAI_C = 0;
	 // par.PAII_C = 0.0625; par.find_PAII_C = 0;
	 ...
	 // b_AROW=-0.1788;
  //}
  //else if (!this->data_name.compare("letter.b"))
  //{
	 ...
	 // par.AROWC_r = 0.03125; par.find_AROWC_r = 0;	  
  //}
  ///*else if (!this->data_name.compare("magic04.b"))
  //{
	 // par.PAI_C = 0.125; par.find_PAI_C = 0;
	 // par.PAII_C = 0.0313; par.find_PAII_C = 0;
	 // par.AROW_r = 1; par.find_AROW_r = 0;
	 // par.AROW_eta = 16; par.find_AROW_eta = 0;
	 // par.AROWC_r = 0.03125; par.find_AROWC_r = 0;	  
  //}*/
  //else if (!this->data_name.compare("optdigits.b"))
  //{
	 // par.PAI_C = 0.25; par.find_PAI_C = 0;
	 // par.PAII_C = 0.25; par.find_PAII_C = 0;
	 // par.AROW_r = 0.25; par.find_AROW_r = 0;
	 // par.AROW_eta = 8; par.find_AROW_eta = 0;
	 // par.AROWC_r = 0.125; par.find_AROWC_r = 0;	  
  //}
  //else if (!this->data_name.compare("satimage.b"))
  //{
	 ...
	 // par.AROWC_r = 0.03125; par.find_AROWC_r = 0;	  
  //}
  //else if (!this->data_name.compare("spambase.b"))
  //{
	 // par.PAI_C = 0.25; par.find_PAI_C = 0;
	 // par.PAII_C = 0.0625; par.find_PAII_C = 0;
	 // par.AROW_r = 0.5; par.find_AROW_r = 0;
	 ...
	 // par.AROWC_r = 0.03125; par.find_AROWC_r = 0;	  
  //}
  //else if (!this->data_name.compare("w8a.b"))
  //{
	 // par.PAI_C = 0.5; par.find_PAI_C = 0;
	 // par.PAII_C = 0.25; par.find_PAII_C = 0;
	 // par.AROW_r = 0.5; par.find_AROW_r = 0;
  ...
  //{
	 ...
	 // par.AROW_r = 0.25; par.find_AROW_r = 0;
	 // par.AROW_eta = 8; par.find_AROW_eta = 0;
	 // par.AROWC_r = 0.031; par.find_AROWC_r = 0;	  
  //}
  //else{}
 ...
 // const char *vinit[] = { "PE", "APE", "RPE", "PA", "APA", "RPA", "PAI", "APAI", "RPAI", "PAII", "APAII", "RPAII", "SOP", "ASOP", "RSOP", "AASOP", "AASOP2", "AROW", "AAROW", "RAROW" };
  ...
  alg_names.push_back("PAII"); alg_names.push_back("APAII"); alg_names.push_back("RPAII");//12
  ...
  if (par.Full_Matrix == 1)
  {
	  ...
	  //alg_names.push_back("AASOP"); alg_names.push_back("AASOP2");//17
  ...
  {      
	  ...
	  //if (i<pow(2.0, (par.b_start + i*par.que_increase_speed));
      for(int j=0; j<par.num_fold; j++)
      {
		  ...
		  //APE
		  //par.b = b;
		  par.b = pow(2.0, (b_APE + i*par.que_increase_speed));
		  //par.b = pow(2.0, (-3.05));
		  cout << b_APE << endl;
		  models[0]->SetAlgName(alg_names[m]);
		  result_tmp.Reset();	par.Reset(data.d, data.n);
		  ...
		  //APAII
		  //par.b = b;
		  par.b = pow(2.0, (b_APAII + i*par.que_increase_speed));
		  //par.b = pow(2.0, -3.8);
		  models[1]->SetAlgName(alg_names[m]);
		  result_tmp.Reset(); par.Reset(data.d, data.n);
		  models[1]->Learning(&result_tmp, &data, &par);
  ...
  {
	  of << endl;
	  of << "b=" <<  pow(2.0, (par.b_start + i*par.que_increase_speed))  << " " << par.b_start + i*par.que_increase_speed << " \t b2= " << pow(2.0, (par.b_start2 + i*par.que_increase_speed2)) << " " << par.b_start2 + i*par.que_increase_speed2 << endl;
  ...
  int a[5];
 a[0]=1; a[1]=10;a[2]=13;a[3]=18;a[4]=17;
//  ofstream of;
  of.open(of_name.c_str());
  of.precision(3);
  of << std::fixed;
  ...
  for (int i = 0; i<par.num_que; i++)//for each query
  {
	  ...
	  for (int ind_alg = 0; ind_alg < 5; ind_alg++)
	  {
		  int j = a[ind_alg];
